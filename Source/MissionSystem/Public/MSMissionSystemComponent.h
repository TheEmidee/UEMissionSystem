...
protected:
    ...
    UFUNCTION( BlueprintImplementableEvent, DisplayName="ReceiveMissionStarted", Category = "Mission System" )
    void K2_ReceiveMissionStarted( UMSMissionData * mission_data );

    UFUNCTION( BlueprintImplementableEvent, DisplayName = "ReceiveMissionEnded", Category = "Mission System" )
    void K2_ReceiveMissionEnded( UMSMissionData * mission_data, bool was_cancelled );

    UFUNCTION( BlueprintImplementableEvent, DisplayName = "ReceiveObjectiveStarted", Category = "Mission System" )
    ...
    UFUNCTION( BlueprintImplementableEvent, DisplayName = "ReceiveObjectiveProgressionUpdated", Category = "Mission System" )
    ...
    UFUNCTION( BlueprintImplementableEvent, DisplayName = "ReceiveObjectiveEnded", Category = "Mission System" )
